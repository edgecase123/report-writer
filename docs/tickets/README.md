...
|---|---|---|---|---|
| [001](001-aggregate-math-dry-consolidation.md) | Consolidate aggregate math (DefinitionFiller ↔ AggregateExpression) | High | dry-solid-reviewer | Open |
| [002](002-delete-dead-code-definition-namespace.md) | Delete dead code: `Interfaces/DataProviderInterface` + entire `Definition/*` namespace | Medium | dry-solid-reviewer | Open |
...
| [006](006-definitionfiller-onband-immutability.md) | Fix `DefinitionFiller::onBand` fluent-returns-but-mutates | Medium | dry-solid-reviewer | Open |
...
| [010](010-library-rename-to-edgecase.md) | Rename library from `foreup/reporting` → `edgecase123/report-writer` | Medium | session-design | Open |
...
| [012](012-implement-standalone-runtime-subproject-a.md) | Implement standalone runtime (Sub-project A) per approved design | Epic | session-design | Blocked on remaining design sections 5-6 |
